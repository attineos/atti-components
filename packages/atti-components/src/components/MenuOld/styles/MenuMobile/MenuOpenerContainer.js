...
const MenuOpenerContainer = styled.span`
  ...
  height: ${({ theme }) => theme.components.menuOld.menuMobile.opener.spaces.height};
  ...
  ${MenuOpenerLine} {
    ...
    &:nth-child(2) {
      margin-top: calc(
        ${({ theme }) =>
          `calc(${theme.components.menuOld.menuMobile.opener.spaces.height} / 2) - calc(${theme.components.menuOld.menuMobile.opener.line.spaces.height} / 2)`}
      );
    ...
    &:nth-child(4) {
      margin-top: calc(
        ${({ theme }) =>
          `${theme.components.menuOld.menuMobile.opener.spaces.height} - ${theme.components.menuOld.menuMobile.opener.line.spaces.height}`}
      );
      opacity: ${({ opened }) => (opened ? '0' : '1')};
    }
  }
